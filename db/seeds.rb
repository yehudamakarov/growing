...
Task.create(name: "be amazing 1", effect: "this is amazing", user: user, day: "sunday")
Task.create(name: "be amazing 2", effect: "this is amazing", user: user, day: "monday")
Task.create(name: "be amazing 3", effect: "this is amazing", user: user, day: "tuesday")
Task.create(name: "be amazing 4", effect: "this is amazing", user: user, day: "wednesday")
Task.create(name: "be amazing 5", effect: "this is amazing", user: user, day: "thursday")
Task.create(name: "be amazing 6", effect: "this is amazing", user: user, day: "friday")
